    ...
    <div class="container bg-green-50/75 dark:bg-green-900 overflow-hidden shadow-xl sm:rounded-lg border-t-4 border-green-700 border max-w-xl mx-auto"
        ...
        <div class="p-6 text-gray-900 dark:text-gray-100">
            ...
            <form action="{{ route('admin.quote.store') }}" method="POST" class="space-y-5">
                ...
                {{-- Isi Quote --}}
                <div>
                    <label for="text" class="block font-medium text-green-800 dark:text-green-300">Isi Quote</label>
                ...
                {{-- Penulis / Sumber --}}
                <div>
                    <label for="source" class="block font-medium text-green-800 dark:text-green-300">Sumber /
                        Penulis</label>
