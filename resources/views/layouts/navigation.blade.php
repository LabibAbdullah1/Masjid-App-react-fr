        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button
                            class="inline-flex items-center px-3 py-2 text-sm leading-4 font-medium rounded-md bg-green-700 hover:bg-green-600 text-white focus:outline-none transition">
            ...
            <div class="-me-2 flex items-center sm:hidden">
                <button @click="open = ! open"
                    class="p-2 rounded-md text-yellow-400 hover:bg-green-700 focus:outline-none">
